...
class DiffPercentThreshold(AnomalyDetectorAlgorithm):
    """
    In this algorithm, anomalies are those data points that are above a
    percentage threshold as compared to the baseline.
    This algorithm assumes that time_series and baseline_time_series are
