...
class Correlator(object):
    ...
    def __init__(self, time_series_a, time_series_b, time_period=None,
                 use_anomaly_score=False, algorithm_name=None,
        ...
        :param time_period: a tuple (start, end) representing a data period for
